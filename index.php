...
<body>
    <a href="#" class="btn-flotante" id="btnCarrito">Carrito de compra<span class="badge bg-success" id="carrito">0</span></a>
    <div class="container">
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-0">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">XILIHER</h1>
                <p class="lead fw-normal text-white-50 mb-0">Accede a nuestro catalogo</p>
            </div>
        </div>
    </header>
    <section class="py-5">
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Made by Herley Diaz</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
